...
from .views import RegisterView, LoginView, MeView, CreateMechanicView, MechanicDetailView,RequestPasswordResetView, ResetPasswordConfirmView,NotificationListView
